...
if(!isset($_SESSION['admin_email'])){
    ...
    if(isset($_GET['edit_cat'])){
        ...
        $select_cat = "select * from catogories where cat_id='$id'";
        $run_cat = mysqli_query($con,$select_cat);
        $assing_data = mysqli_fetch_array($run_cat);
        $title = $assing_data['cat_title'];
    }
}
?>
    ...
    <body>
        <div class="container">
            <div class="inner-container">
                <div class="header">
                    <p>EDIT CATEGORY</p><br><br>
                </div>
                <div class="input">
                    <form action="" method="post">
                    <label class="lbl">Category Title</label><br><br>
...
<?php 
    if(isset($_POST['update'])){
        ...
        $update_cat = "update catogories set cat_title='$update_title' where cat_id='$id'";
