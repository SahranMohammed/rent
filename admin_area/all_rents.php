    ...
    <body>
        ...
        <table id="customers">
            ...
            <tr><td><?php echo $no; ?></td>
                ...
                <td><i class="fas fa-pencil-alt" style="color:blue"></i>&nbsp;<a href="index.php?edit_orders=<?php echo $id; ?>">Edit</a></td>
                <td><a href="delete_orders.php?delete_order=<?php echo $id; ?>">Returned</a></td>
